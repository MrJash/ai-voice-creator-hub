...
Welcome to the AI Voice Creator Hub SaaS application! This is a production-ready platform that combines a modern Next.js 16 frontend with a powerful Python backend for AI-powered text-to-speech generation. The application features secure authentication, payment processing, real-time audio generation, and a comprehensive project management system.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/mrjash/ai-voice-creator-hub-app.git
   cd ai-voice-Creator Hub-app
   ```
...
# Database
npx prisma Creator Hub    # Open Prisma Creator Hub
...
- **GitHub Repo** → https://github.com/sahandghavidel/ai-voice-Creator Hub-app
