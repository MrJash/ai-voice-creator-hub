...
app = modal.App("ai-voice-creator-hub-jash")
...
volume = modal.Volume.from_name("hf-cache-ai-voice-creator-hub", create_if_missing=True)

s3_secret = modal.Secret.from_name("ai-voice-creator-hub-aws-secret")
...
@app.cls(
    ...
    volumes={
        ...
        "/s3-mount": modal.CloudBucketMount("ai-voice-creator-hub-jash", secret=s3_secret)
    },
