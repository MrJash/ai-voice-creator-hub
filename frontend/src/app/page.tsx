...
export default function HomePage() {
  const features = [
    {
      ...
      title: "Voice Cloning",
      description:
        "Choose from the high quality voice presets or clone your own voice.",
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-indigo-50/20 to-slate-100">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              <Image src="/logo.png" alt="AI Voice Creator Hub" width={32} height={32} className="h-8 w-8" />
              <span className="bg-linear-to-r from-indigo-600 to-cyan-600 bg-clip-text text-xl font-bold text-transparent">
            ...
            {[
              ...
              <div key={index} className="relative">
                <div className="mb-4 flex items-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-linear-to-r from-indigo-500 to-cyan-600 text-lg font-bold text-white shadow-lg">
                    {item.step}
                  </div>
                  {index < 2 && (
      ...
      <section id="testimonials" className="bg-white py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              See what our users are saying about AI Voice Creator Hub
            </p>
          </div>
      ...
      <section
        id="pricing"
        className="bg-linear-to-br from-slate-50 to-indigo-50/50 py-20 sm:py-32"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl">
          ...
          <div className="mx-auto max-w-lg">
            <Card className="relative overflow-hidden border-2 border-indigo-300 bg-white/70 backdrop-blur-sm">
              <div className="absolute top-0 right-0 bg-linear-to-r from-indigo-500 to-cyan-600 px-4 py-1 text-sm font-medium text-white">
                Free to Start
              </div>
              <CardContent className="p-8">
                ...
                <Link href="/dashboard">
                  <Button
                    className="w-full cursor-pointer gap-2 bg-linear-to-r from-indigo-500 to-cyan-600 hover:from-indigo-600 hover:to-cyan-700"
                    size="lg"
                  >
      ...
      <section className="bg-linear-to-r from-indigo-100/70 to-cyan-100/70 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link href="/dashboard">
                <Button
                  size="lg"
                  className="cursor-pointer gap-2 bg-linear-to-r from-indigo-500 to-cyan-600 px-8 py-6 text-base hover:from-indigo-600 hover:to-cyan-700"
                >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-16">
            <div className="grid gap-8 md:grid-cols-4">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-600">
                  <li>
                    <Link
                      href="mailto:jashrmewada@gmail.com"
                      className="transition-colors hover:text-indigo-600"
                    >
                      Contact
                    </Link>
            ...
            <div className="mt-16 border-t border-slate-200 pt-8 text-center text-sm text-slate-500">
              <p>&copy; 2026 AI Voice Creator Hub. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
