...
export default function DemoSection() {
  ...
  return (
    <section id="demo" className="scroll-mt-20 bg-linear-to-br from-indigo-50/50 to-cyan-50/30 py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="cursor-pointer gap-2 bg-linear-to-r from-indigo-500 to-cyan-600 hover:from-indigo-600 hover:to-cyan-700"
            >
